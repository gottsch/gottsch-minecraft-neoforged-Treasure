...
public class CollidingParticleType extends ParticleType<CollidingParticleType> implements ParticleOptions, ICollidingParticleType {
	 ...
	 */
	public static final ParticleOptions.Deserializer<CollidingParticleType> DESERIALIZER = new ParticleOptions.Deserializer<CollidingParticleType>() {
		...
		@Override
		public CollidingParticleType fromNetwork(ParticleType<CollidingParticleType> type,	FriendlyByteBuf buf) {
			int x = buf.readInt();
			int y = buf.readInt();
			int z = buf.readInt();
			ICoords coords = new Coords(x, y, z);
	 ...
	 * @param deserializer
	 */
	public CollidingParticleType(ICoords coords, ParticleOptions.Deserializer<CollidingParticleType> deserializer) {
