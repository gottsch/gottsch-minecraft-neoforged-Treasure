...
import mod.gottsch.neo.gottschcore.json.JSMin;
...
public interface ITreasureResourceRegistry {
	 ...
	 * @throws Exception
	 */
	public static <T> T readResourcesFromStream(InputStream inputStream, Class<T> resourceClass) throws IOException, Exception {
		...
		try {
			...
			Treasure.LOGGER.debug("resources -> {}", resources);
