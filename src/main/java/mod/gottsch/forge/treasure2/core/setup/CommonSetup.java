...
public class CommonSetup {
	...
	public static void init(final FMLCommonSetupEvent event) {
		 ...
		 */
		// NOTE see TreasureFeatureGenerators.initialize() for setting weights by configuration.
		// NOTE you can alter the weights in the treasure2-chests-xxx-vx.toml file
		...
		// TEMP remove surface structure until bugs fixed.
